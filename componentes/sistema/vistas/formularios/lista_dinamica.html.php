...
<select id="<?php echo $id_lista_dinamica ?>" name="<?php echo $nombre_lista_dinamica ?>" class="form-control" style="width: 100%;"  <?php if(isset($obligatorio) and $obligatorio == "TRUE"): ?>required=""<?php endif; ?> >    
</select>
