...
class Usuarios extends Modelos {
    ...
    private static
            $sqlCompleta = <<<EOD
        SELECT  cargosempleados.*, usuarios.*, personas.*, tiposidentificacion.* FROM usuarios  
        LEFT JOIN cargosempleados ON ( usuarios.usuarioCargo = cargosempleados.cargoEmpleadoId )  
        LEFT JOIN personas ON (usuarios.usuarioPersona = personas.personaId)   
...
";
    ...
    public static
        ...
        $query = 'SELECT funciones_sistema.TITULO_MENU, permisos_usuario.*             '
                ...
                . 'GROUP BY funciones_sistema.ID_MENU '
...
VALUES ( '" . session_id() . "', 'SALIDA', " . $idUsuario . ", " . $idPersona . ", '" . self::ipUsuario() . "' )";
    ...
    public static
            function insertar($usuarioPersona, $usuarioCargo, $usuarioTipo, $usuarioNombre, $usuarioClave, $usuarioCorreo, $usuarioTelefono = NULL, $usuarioAvatar = NULL) {
        ...
        $resultado = self::crearUltimoId(
                        $query, array($usuarioPersona, $usuarioCargo, $usuarioTipo, $usuarioNombre, $usuarioClave, $usuarioCorreo,
    ...
    public static
            function actualizar($usuarioId, $usuarioPersona, $usuarioCargo, $usuarioTipo, $usuarioNombre, $usuarioCorreo, $usuarioTelefono = NULL, $usuarioAvatar = NULL) {
        ...
        $resultado = self::modificarRegistros(
                        $query, array($usuarioPersona, $usuarioCargo, $usuarioTipo, $usuarioNombre, $usuarioCorreo,
    ...
    public static
            function actualizarSinAvatar($usuarioId, $usuarioPersona, $usuarioCargo, $usuarioTipo, $usuarioNombre, $usuarioCorreo, $usuarioTelefono = NULL) {
