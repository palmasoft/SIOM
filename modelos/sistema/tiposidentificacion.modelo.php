...
class TiposIdentificacion extends Modelos {
  ...
  private static $nTabla = "tiposidentificacion";
  private static $sqlBase = "SELECT tiposidentificacion.* FROM tiposidentificacion ";
  ...
  static public function insertar($tipoIdentificacionCodigo, $tipoIdentificacionTitulo,
  ...
  static public function actualizar($idTipoEquipo, $tipoIdentificacionCodigo,
          $tipoIdentificacionTitulo, $tipoIdentificacionDesc) {
