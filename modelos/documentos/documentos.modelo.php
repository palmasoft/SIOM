...
class Documentos extends Modelos {
  ...
  static public
   function insertar($documentoCodigo, $documentoTipo, $documentoConsecutivo,
                     $documentoTitulo, $documentoUrl) {
  ...
  static public
   function actualizar($idTipoEquipo, $tipoEquipoCodigo, $tipoEquipoTitulo,
                       $tipoEquipoDesc) {
