...
EOD;
    ...
    if(!is_null($DatosServicio->depositoRecibo)) {
      $depositoValor = "$ " . number_format($DatosServicio->depositoRecibo->reciboDepositoValor, 0, ',', '.');
...
EOD;
    ...
    $ncliente = $DatosServicio->personaRazonSocial;
    $icliente = $DatosServicio->tipoIdentificacionCodigo . " " . $DatosServicio->personaIdentificacion;
    if(!empty($DatosServicio->nombresReferencia)) {
      $ncliente = $DatosServicio->nombresReferencia . " " . $DatosServicio->apellidosReferencia;
      $icliente = "C.C. " . $DatosServicio->idReferencia;
    }
    ...
    $legalHtml = <<<EOD
     ...
     <table>
       <tr>
        <td width="50%" style="margin-top: 10px; background-color: #f5f5f5; padding: 2px;">
          <div style="text-align: center;font-size: 80%">$infoLegal</div>
        </td>
        <td width="25%" style="text-align:center;font-size: 60%" >
        ...
        <td width="25%" style="text-align:center;font-size: 60%" >
          <img src="archivos/oximeiser/img/transparente.png" style="width: 120px; height: 90px;" /><br>
            ____________________<br>
          $ncliente<br>
          $icliente    
        </td>
...
// This method has several options, check the source code documentation for more information.
    ...
    return Documentos::insertar($documentoCodigo, $documentoTipo, $DatosServicio->reciboNumero, $documentoTitulo,
