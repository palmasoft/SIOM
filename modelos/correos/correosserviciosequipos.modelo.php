...
class CorreosServiciosEquipos {
  ...
  static
   function enviarNuevoServicioEquipos($DatosServicio) {
    ...
    $htmlContenido = Archivos::leer_archivo(PATH_MODELOS . "correos" . DS . "servicios" . DS . "nuevoservicioequipos.html.php");
...
//    $mail->addBCC('bcc@example.com');
  ...
  static
   function enviarAnuladoServicioEquipos($DatosServicio, $DatosRazon, $descripcion) {
    ...
    $htmlContenido = Archivos::leer_archivo(PATH_MODELOS . "correos" . DS . "servicios" . DS . "anuladoservicioequipos.html.php");
